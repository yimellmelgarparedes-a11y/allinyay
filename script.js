...
if (createSantuarioForm) {
    createSantuarioForm.addEventListener('submit', async (e) => {
        ...
        const options = document.querySelectorAll('#admin-avatar-gallery .avatar-option'); if(options) options.forEach(o => o.classList.remove('selected'));
...
// =========================================================================
// LÓGICA DE SELECCIÓN DE AVATARES RÁPIDOS EN EL FORMULARIO DE CREACIÓN (ADMIN)
// =========================================================================
    ...
    if (avatarGallery && adminAvatarInput) {
        ...
        options.forEach(option => {
            option.addEventListener('click', () => {
                // Remover la clase de selección de todos los elementos
                options.forEach(opt => opt.classList.remove('selected'));
                
                // Añadir la clase al elemento seleccionado
                option.classList.add('selected');
                
                // Asignar el emoji al input
